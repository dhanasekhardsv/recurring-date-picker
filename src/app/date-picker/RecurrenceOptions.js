...
const RecurrenceOptions = () => {
    const { recurrenceType, interval, selectedDays, setRecurrenceType, setInterval, toggleSelectedDay } = useDatePickerStore();
                ...
                recurrenceType === 'weekly' && (
                    <div className="flex flex-wrap gap-2">
                        {WEEK_DAYS.map((day, index) => (
                            <button key={day} onClick={() => toggleSelectedDay(index)}
